...
_G.packer_plugins = {
  ...
  ["bluloco.nvim"] = {
    loaded = true,
    path = "/home/kkpagaev/.local/share/nvim/site/pack/packer/start/bluloco.nvim",
  ...
  ["copilot-cmp"] = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/home/kkpagaev/.local/share/nvim/site/pack/packer/opt/copilot-cmp",
    url = "https://github.com/zbirenbaum/copilot-cmp"
  },
  ["copilot.lua"] = {
    loaded = true,
    path = "/home/kkpagaev/.local/share/nvim/site/pack/packer/start/copilot.lua",
  ...
  harpoon = {
    ...
    url = "https://github.com/kappagaev/harpoon"
  },
  ["hover.nvim"] = {
    loaded = true,
  ...
  ["lspsaga.nvim"] = {
    config = { "\27LJ\2\n\v\0\0\1\0\0\0\1K\0\1\0\0" },
    loaded = true,
    path = "/home/kkpagaev/.local/share/nvim/site/pack/packer/start/lspsaga.nvim",
  ...
  ["lush.nvim"] = {
    loaded = true,
    path = "/home/kkpagaev/.local/share/nvim/site/pack/packer/start/lush.nvim",
  ...
  ["nvim-rooter.lua"] = {
    config = { "\27LJ\2\n\v\0\0\1\0\0\0\1K\0\1\0\0" },
    loaded = true,
    path = "/home/kkpagaev/.local/share/nvim/site/pack/packer/start/nvim-rooter.lua",
  ...
  ["nvim-surround"] = {
    config = { "\27LJ\2\n\v\0\0\1\0\0\0\1K\0\1\0\0" },
    loaded = true,
    path = "/home/kkpagaev/.local/share/nvim/site/pack/packer/start/nvim-surround",
  ...
  ["onenord.nvim"] = {
    loaded = true,
    path = "/home/kkpagaev/.local/share/nvim/site/pack/packer/start/onenord.nvim",
  ...
  ["papercolor-theme"] = {
    loaded = true,
    path = "/home/kkpagaev/.local/share/nvim/site/pack/packer/start/papercolor-theme",
  ...
  ["telescope-rooter.nvim"] = {
    loaded = true,
    path = "/home/kkpagaev/.local/share/nvim/site/pack/packer/start/telescope-rooter.nvim",
  ...
  ["tmux.nvim"] = {
    loaded = true,
    path = "/home/kkpagaev/.local/share/nvim/site/pack/packer/start/tmux.nvim",
  ...
  ["vim-crystal"] = {
    loaded = true,
    path = "/home/kkpagaev/.local/share/nvim/site/pack/packer/start/vim-crystal",
  ...
  vimwiki = {
    loaded = true,
    path = "/home/kkpagaev/.local/share/nvim/site/pack/packer/start/vimwiki",
    url = "https://github.com/vimwiki/vimwiki"
  },
  ["which-key.nvim"] = {
    loaded = true,
    path = "/home/kkpagaev/.local/share/nvim/site/pack/packer/start/which-key.nvim",
...
try_loadstring("\27LJ\2\n\v\0\0\1\0\0\0\1K\0\1\0\0", "config", "copilot-cmp")
