...
_G.packer_plugins = {
  ["barbar.nvim"] = {
    loaded = true,
    path = "/home/kkpagaev/.local/share/nvim/site/pack/packer/start/barbar.nvim",
    url = "https://github.com/romgrk/barbar.nvim",
    wants = { "nvim-web-devicons" }
  },
  ["coc.nvim"] = {
    loaded = true,
    path = "/home/kkpagaev/.local/share/nvim/site/pack/packer/start/coc.nvim",
  ...
  ["lazygit.nvim"] = {
    loaded = true,
    path = "/home/kkpagaev/.local/share/nvim/site/pack/packer/start/lazygit.nvim",
  ...
  ["vim-go"] = {
    loaded = true,
    path = "/home/kkpagaev/.local/share/nvim/site/pack/packer/start/vim-go",
